...
# Things we need for Agent to interact with game
# Reset function to start over
# Reward to tell agent how well AI did
# Play(action) -> direction - Not exactly sure what this will do just yet
# Game iteration to keep track of how many games it's been through
# is_collision to check if snake collided
